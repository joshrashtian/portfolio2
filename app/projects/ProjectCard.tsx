...
ProjectCard.Link = function ProjectCardLink() {
  const { link, source, iosLink, androidLink } = useProjectContext();
      ...
      {iosLink && (
        ...
        >
          ...
          >
            ...
            />
            <path d="M265.471 626.12C284.647 595.758 329.491 609.042 330.39 643.199C325.296 664.872 313.511 684.647 298.53 701.027C275.758 724.997 235.009 703.124 242.5 670.864C246.195 654.485 256.882 640.302 265.471 626.12Z" />
          </svg>
          <h1>App Store</h1>
        </Link>
      )}
