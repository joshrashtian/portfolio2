...
const CustomCursor = ({
  ...
  const variants = {
    ...
    focus: { scale: 2, borderColor: "red" },
    click: { scale: 1.4, borderColor: "yellow" },
  };

  return (
    <div className="cursor-none">
      <motion.div
        className="pointer-events-none fixed top-0 left-0 z-[9999] h-4 w-4 rounded-full border-2 border-dashed bg-transparent mix-blend-difference"
