    ...
    >
      ...
      <li className="flex flex-row gap-2 text-4xl text-zinc-700">
        ...
        <svg
          ...
          role="img"
          className="h-[36px] w-[36px] fill-zinc-700 duration-300"
          viewBox="0 0 512 512"
        >
        ...
        <svg
          ...
          className="h-[36px] w-[36px] fill-zinc-700"
        >
          <g>
        ...
        <svg
          version="1.1"
          viewBox="0 0 512 512"
          className="-mr-4 h-[36px] w-[36px] -translate-x-2 fill-zinc-700"
        >
          <g id="_x31_81-java">
            <g>
              <path d="M333.283,307.117c8.807-6.02,21.023-11.23,21.023-11.23s-34.768,6.29-69.357,9.165    c-42.315,3.503-87.775,4.221-110.595,1.167c-53.996-7.187,29.647-27.044,29.647-27.044s-32.433-2.154-72.413,17.07    C84.422,319.066,248.383,329.487,333.283,307.117z" />
              <path d="M256.56,278.277c-17.07-38.362-74.659-72.054,0-130.99C349.727,73.797,301.93,26,301.93,26    c19.316,75.917-67.92,98.917-99.456,146.084C181.001,204.337,212.986,238.927,256.56,278.277z" />
              <path d="M359.518,119.975c0.09,0-157.403,39.351-82.205,125.958c22.191,25.516-5.84,48.516-5.84,48.516    s56.332-29.108,30.457-65.495C277.762,194.993,259.254,178.103,359.518,119.975z" />
              <path d="M354.039,362.999c-0.449,1.078-1.797,2.247-1.797,2.336    c115.266-30.277,72.861-106.824,17.787-87.416c-4.852,1.707-7.365,5.66-7.365,5.66s3.053-1.259,9.883-2.696    C400.396,275.044,440.377,318.168,354.039,362.999L354.039,362.999z" />
              <path d="M396.443,418.971c0,0,13.027,10.692-14.285,19.047c-52.018,15.722-216.339,20.483-261.979,0.63    c-16.441-7.099,14.374-17.072,24.078-19.137c10.061-2.157,15.901-1.799,15.901-1.799c-18.238-12.847-117.963,25.247-50.671,36.119    C292.945,483.657,444.061,440.443,396.443,418.971L396.443,418.971z" />
              <path d="M195.557,381.776c-70.706,19.766,43.035,60.555,133.055,22.011    c-14.732-5.748-25.334-12.397-25.334-12.397c-40.16,7.637-58.756,8.175-95.233,4.043    C177.948,392.019,195.557,381.776,195.557,381.776L195.557,381.776z" />
              <path d="M357.092,469.103c-70.705,13.296-157.941,11.771-209.602,3.233c0-0.088,10.602,8.716,65.046,12.22    c82.834,5.302,210.051-2.966,213.016-42.136C425.553,442.42,419.803,457.245,357.092,469.103L357.092,469.103z" />
              <path d="M317.922,343.144c-53.188,10.243-84.003,9.973-122.904,5.93    c-30.098-3.145-10.422-17.698-10.422-17.698c-77.982,25.874,43.304,55.164,152.281,23.269    C325.289,350.601,317.922,343.144,317.922,343.144z" />
            </g>
          </g>
          <g id="Layer_1" />
        </svg>
      </li>
      <h5 className="text-xl">Libraries / Technologies:</h5>
      <li className="flex flex-row gap-2 text-4xl text-zinc-700">
        <IoLogoElectron />
        <IoLogoVercel />
        <IoLogoFirebase />
      ...
      <li className="flex flex-row gap-2 fill-zinc-700 text-4xl text-zinc-700">
        ...
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
        >
          <path d="M 13,5.065 12.0405,2.6875 11.44,1.2475 8.6505,1 8.215,1.42 7.66,1.21 5.8975,2.1475 4,1.0225 1,2.2525 2.6125,11.838 9.25,13 l 0.42,-2.13 0.075,-0.0455 -6.57,0 0,-7.6495 7.65,0 0,7.0125 2.175,-1.29 -1.3125,-2.46 m -8.3625,4.238 7.35,0 0,-7.3505 -7.35,0 0,7.3505 z m 3.4505,-0.863 -2.8125,0 0,-0.4725 2.8125,0 0,0.4725 z M 8.838,4.165 c 0.412,0 0.824,0.15 1.1395,0.3975 L 9.625,5.0875 C 9.4005,4.908 9.1225,4.8025 8.838,4.7875 8.59,4.7875 8.44,4.9 8.44,5.0725 8.44,5.2745 8.5755,5.35 9.0995,5.4775 9.715,5.65 10.075,5.875 10.075,6.415 10.075,7.0375 9.6025,7.39 8.95,7.39 8.4695,7.375 8.0045,7.1945 7.6375,6.8875 L 8.027,6.3995 c 0.285,0.225 0.5625,0.375 0.923,0.375 0.2775,0 0.45,-0.1125 0.45,-0.3 C 9.4,6.3015 9.2865,6.212 8.785,6.077 8.162,5.912 7.765,5.739 7.765,5.1245 l 0,-0.022 C 7.765,4.54 8.215,4.165 8.838,4.165 Z m -4.3125,0.06 0.472,1.8 0.525,-1.8 0.525,0 0.5255,1.8 0.4645,-1.8 0.7355,0 -0.9,3.1125 -0.5855,0 -0.502,-1.8 -0.51,1.8 -0.5775,0 -0.9005,-3.1125 0.728,0 z" />
        </svg>
        <svg
          className="h-[36px] w-[36px] fill-zinc-700"
          viewBox="0 0 256 256"
        ...
        >
          <g id="vlpa">
            <g id="vlpb">
              <g id="vlpc">
                <g id="vlpd">
                  <path d="M42.5,0h155C221,0,240,19,240,42.5v149c0,23.5-19,42.5-42.5,42.5h-155C19,234,0,215,0,191.5v-149      C0,19,19,0,42.5,0z" />
                </g>
              </g>
            </g>
            <g id="vlpe" className="fill-slate-50">
              <g id="vlpf">
