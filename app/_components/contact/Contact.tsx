...
const Contact = () => {
  ...
  return (
    ...
    >
      ...
      >
        <input
          className="h-8 w-full rounded-md bg-zinc-100 p-2 duration-1000 focus:text-purple-500 dark:bg-zinc-500 dark:text-white dark:focus:text-pink-300"
          placeholder="Subject..."
          type="text"
        ...
        />
        <textarea
          className="h-20 w-full resize-none overflow-y-scroll rounded-md bg-zinc-100 p-2 duration-1000 focus:text-purple-500 dark:bg-zinc-500 dark:text-white dark:focus:text-pink-300"
          placeholder="Message..."
          required
