...
const FeaturedProjects = () => {
  return (
    <>
      ...
      <ul className="snap-point no-scrollbar flex h-96 w-full snap-x snap-mandatory flex-row gap-24 overflow-x-scroll scroll-smooth whitespace-nowrap bg-zinc-100/30 p-10 px-52">
