...
export const Degrees: GeneralModalProps[] = [
  {
    ...
    svg: () => (
      <svg
        ...
        viewBox="50 0 200 143"
      >
        <g>
          <g stroke-width=".22553">
            ...
            <path d="m149.8 66.7 19.2-19.2c4.9-4.9 9.8-0.1 9.8-0.1l-4.8-4.8s-7.4-7.1-14.6 0.1l-24.1 24.1h14.5z" />
          </g>
          <g stroke-width=".22553">
